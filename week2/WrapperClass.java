...
public class WrapperClass {
  public static void main(String[] args) {
    ...
    // Float.compareTo(...) -> 0, -1, 1
    // 0 if the two Float objects are equal.
    // -1 if the first Float object is less than the second one.
    // 1 if the first Float object is greater than the second one.
